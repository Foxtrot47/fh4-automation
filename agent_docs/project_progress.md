...
**Status:** In progress — offline tooling accepted; four solo sessions provide approximately 59.28 validated frame-equivalent minutes.
...
- FH4-300 has four accepted Rivals solo sessions (approximately 59.28 frame-equivalent minutes) and still requires approximately 60.72 minutes for the two-hour minimum plus enough whole sessions for held-out split/baseline coverage.
