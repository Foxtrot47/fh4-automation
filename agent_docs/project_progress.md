...
**Status:** In progress — offline tooling accepted; two solo sessions provide approximately 29.52 validated frame-equivalent minutes.
...
- FH4-300 has two accepted Rivals solo sessions (approximately 29.52 frame-equivalent minutes) and still requires approximately 90.48 minutes for the two-hour minimum plus enough whole sessions for held-out split/baseline coverage.
