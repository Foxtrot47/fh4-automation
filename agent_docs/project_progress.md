...
**Status:** In progress — offline tooling accepted; three solo sessions provide approximately 44.51 validated frame-equivalent minutes.
...
- FH4-300 has three accepted Rivals solo sessions (approximately 44.51 frame-equivalent minutes) and still requires approximately 75.49 minutes for the two-hour minimum plus enough whole sessions for held-out split/baseline coverage.
