...
**Status:** In progress — offline tooling accepted; solo collection started with 14.53 validated minutes.
...
- FH4-300 has one accepted Rivals solo session (14.53 usable minutes) and still requires at least 105.47 more minutes for the two-hour minimum plus enough whole sessions for held-out split/baseline coverage.
...
Record Rivals solo session 002 for 900 seconds with the A-release gate and progress timer, validate it immediately, and inspect representative frames. Continue to at least eight accepted approximately 15-minute solo sessions for the two-hour minimum; prefer ten or more for stronger 80/10/10 split granularity. Keep clean-lap and deliberate safe-recovery sessions identifiable, do not use rewind, and exclude traffic sessions from the solo corpus. Build the immutable dataset and human baseline report only after collection and independent acceptance. Azure quota remains independent of local dataset work.
